...
{
    public static class TextConnectorPrecessor
    {
        ...
        public static void SaveToPrizeFile(this List<PrizeModel> models, string fileName)
        {
            ...
            {
                lines.Add($"{ p.Id},{p.PlaceName},{p.PrizeAmount},{p.PrizePercentage}");
            }
        ...
        private static List<MatchupEntryModel> ConvertToMatchupEntryModels(this List<string> lines)
        {
            ...
            foreach (string line in lines)
            {
                ...
                me.ParentMatchup = LookupMatchupById(int.Parse(cols[1]));
        ...
        private static TeamModel LookupTeamById(int id)
        {
            ...
            foreach (string team in teams)
            {
                ...
                if (cols[0] == id.ToString())
                {
                    ...
                    return matchingTeams.ConvertToTeamsModels(GlobalConfig.PersonsFile).First();
                }
            }
        ...
        public static void SaveToTournamentFile(this List<TournamentModel> models, string fileName)
        {
            ...
            foreach (TournamentModel tm in models)
            {
                ...
                lines.Add($"{tm.Id},{tm.TournamentName},{tm.EntryFee},{ ConvertTeamListToString(tm.EnteredTeams)},{ ConvertPrizesListToString(tm.Prizes)},{ ConvertROundsListToString(tm.Rounds)}");
            }
